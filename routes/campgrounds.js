...
// Edit Route
router.get("/campgrounds/:id/edit", checkAuthorisation, function(req, res){
...
// Update Route
router.put("/campgrounds/:id", checkAuthorisation, function(req, res){
...
// Delete Route
router.delete("/campgrounds/:id", checkAuthorisation, function(req, res){
